...
String City             = "Skierniewice";                  // Your home city See: http://bulk.openweathermap.org/sample/
String Latitude         = "51.95";                         // Latitude of your location in decimal degrees
String Longitude        = "20.14";                         // Longitude of your location in decimal degrees
